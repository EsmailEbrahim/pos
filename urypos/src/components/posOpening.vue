<template>
        ...
        <table class="w-full text-left text-sm text-gray-500 dark:text-gray-400">
            ...
            <tbody>
                <tr class="border-b bg-white dark:border-gray-700 dark:bg-gray-900"
                    v-for="(modeOfPayment, index) in invoiceData.modeOfPaymentList" :key="index">
                    ...
                    <td class="px-6 py-4">
                        <button class="p-2 text-center" type="button" @click="this.posOpen.deleteRow(index)">
                            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor border"
    ...
    <div v-if="this.posOpen.showSumbitPosOpen" class="fixed inset-0 z-10 mt-20 overflow-y-auto bg-gray-100">
