<template>
  ...
  <div class="container m-auto">
    <div class="mb-6 gap-6 grid md:grid-cols-2 lg:grid-cols-2">

      <div class="">
        <div class="relative mb-4 mt-4" ref="container">
          <div
          ...
          <input
            type="search"
            class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 pl-10 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500 md:w-3/5 lg:w-4/5"
        ...
        <div v-if="this.customers.showModalNewCustomer" class="fixed inset-0 z-10 mt-20 overflow-y-auto bg-gray-100">
  ...
  <div class="mt-5 flex w-full flex-col justify-between gap-2 md:flex-row lg:mt-2">
    <div
...
export default {
  ...
  setup() {
    ...
    return { menu, customers, auth, recentOrders,menu };
  },
};
</script>
