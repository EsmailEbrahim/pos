    ...
    <div class="flow-root mt-2 py-2">
        ...
        <div class="grid grid-cols-2 gap-4 md:grid-cols-4 lg:grid-cols-6 xl:grid-cols-8">
            <div w-full
                ...
                v-for="table in this.table.takeAway" :key="table.name">
                ...
                'bg-green-100 text-green-800':
                    ...
                    <div class="relative" v-if="table.occupied === 1">
                        <button
                            ...
                            type="button" @click="this.table.toggleDropdown(table.name)">
                        ...
                        <div class="absolute right-0 z-10 w-36 divide-y divide-gray-100 rounded bg-white shadow dark:bg-gray-700"
                            v-show="this.table.activeDropdown === table.name">
                            <ul class="py-2">
                                <li>
                                    <a href="#"
                                        class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-600 dark:hover:text-white"
                                        @click="this.table.showModal = true">تغيير الطاولة</a>
                                </li>
                                <li v-if="this.auth.hasAccess">
                                    <a href="#"
                                        class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-600 dark:hover:text-white"
                                        @click="this.table.showModalCaptainTransfer = true">تغيير الكابتن</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="flex flex-col pb-4">
                    <div class="mt-1 text-center" @click="
